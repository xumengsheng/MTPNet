...
if __name__ == "__main__":
    ...
    # parser.add_argument('--input',type=str,default='D:/Flare/Flare7K-main/results/DFNet1_s1/visualization/flare_test')
    # parser.add_argument('--gt',type=str,default='D:/Flare/Flare7K-main/Flare7Kpp/test_data/synthetic/gt')
    # parser.add_argument('--mask',type=str,default='D:/Flare/Flare7K-main/Flare7Kpp/test_data/synthetic/mask')
    parser.add_argument('--input',type=str,default='D:/Flare/Flare7K-main/results/DFNet1_r/visualization/flare_test')
    parser.add_argument('--gt',type=str,default='D:/Flare/Flare7K-main/Flare7Kpp/test_data/real/gt')
    parser.add_argument('--mask',type=str,default='D:/Flare/Flare7K-main/Flare7Kpp/test_data/real/mask')
